...
class BeforeHomeAdmin extends Component {
  uid = '';
  messagesRef = null;
 sexual = [{
    value: 'man',
...
to_age = [];
  ...
  onChangeFromAge(text)
  {
     ...
     for (var i=Number(text); i < 80; i=i+2)
    {
  ...
  onNext()
  {
    this.props.navigation.navigate("HomeAdmin",{lookingfor:this.state.lookingfor,fromage:this.state.fromage,toage:this.state.toage,aroundme:this.state.aroundme});
  }
...
export default BeforeHomeAdmin;
